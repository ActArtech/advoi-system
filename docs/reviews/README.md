...
| [ARCHITECTURE-DATA-MEMORY-REVIEW.md](ARCHITECTURE-DATA-MEMORY-REVIEW.md) | Architecture, data, platform | Vertical/horizontal map, data authority, ADR-026 gaps; source for [06-vertical-boundaries](../architecture/06-vertical-boundaries.md) · [08-system-logic-flows](../architecture/08-system-logic-flows.md) |
